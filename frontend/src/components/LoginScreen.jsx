    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
                ...
                <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-brand-secondary/20 rounded-full mix-blend-screen filter blur-[60px] opacity-60 animate-blob animation-delay-2000"></div>
            ...
            <div className="w-full max-w-md backdrop-blur-md p-8 rounded-3xl text-center relative z-10">
                ...
                <button
                    onClick={handleLogin}
                    disabled={loading}
                    className="w-full bg-white text-black font-bold py-4 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-200 transition-all shadow-lg active:scale-[0.98] group"
                >
                    {loading ? (
